...
import "../src/UniswapV3Pool/UniswapV3Pool.sol";

contract UniswapV2Router02Test is Test {
    event OraclePrice(
        uint32 blockTimestampMean,
        int56 tickCumulativeMean,
        uint160 secondsPerLiquidityCumulativeX128Mean,

        uint32 blockTimestampWinsorized,
        int56 tickCumulativeWinsorized,
        uint160 secondsPerLiquidityCumulativeX128Winsorized,
        int56 tickWinsorized
    );

    function testSwap_emitsOraclePrice() public {
        // Replay transaction: 0x885f7c26504b7e8048b0296d85f754dfb2c6fd9924199fb7a66495500280318f
        IUniswapV3Pool pool = deployAtBlock(11508784);
